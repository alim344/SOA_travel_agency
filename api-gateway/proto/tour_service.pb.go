...
type TourExecutionResponse struct {
	...
	CompletedKeyPointsWithTime map[int64]string       `protobuf:"bytes,10,rep,name=completed_key_points_with_time,json=completedKeyPointsWithTime,proto3" json:"completed_key_points_with_time,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // KLJUČNO ZA TVOJU MAPU!
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
